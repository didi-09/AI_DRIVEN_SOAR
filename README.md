...
The Observer ingests three distinct data streams.
...
**Tokenization**: Rolling hash: $h = (31 \times h + \text{ord}(c)) \& \text{0xFFFFFFFF}$. Normalized to [0-1].
...
Key metrics: `cpu_percent`, `mem_percent`, `tx_bps` (Log-scaled), `active_conns` (Log-scaled).
...
| :--- | :--- | :--- | :--- | :--- |
| **Observer Architecture** | 1-Layer | 2-Layer | **3-Layer "Deep Eyes"** | ✅ Solved |
| **Latent Dims** | 12D (Zero Var) | 12D (Low Var) | **12D (High Var)** | ✅ Solved |
| **Bootstrap** | Standard | Noisy | **Contrastive Synthetic** | ✅ Solved |
